# Project Title
- This is my implementation of Long Short Term Memory (LSTM). I have coded LSTM from scratch in Tensorflow. Details of the implementation are provided below.
